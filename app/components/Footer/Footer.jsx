    ...
    <div class="w-full lg:w-6/12 mt-10 lg:mt-1">
      <div class="flex justify-end items-center gap-5">
        <div class="lg:w-[250px]">
          <span class="block text-center lg:text-right">© LWS Shop Center 2024</span>
          <p class="text-center lg:text-right mt-2">All images and content may not be used without permission</p>
        </div>
      </div>
    </div>
  </footer>
